...
<body>
    <div id="app">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('listing_access')
                                        <a class="dropdown-item" href="{{ route('frontend.listings.index') }}">
                                            {{ trans('cruds.listing.title') }}
                                        </a>
                                    @endcan
                                    @can('helper_access')
                                        <a class="dropdown-item disabled" href="#">
                                            {{ trans('cruds.helper.title') }}
                                        </a>
                                    @endcan
                                    @can('property_access')
                                    ...
                                    @endcan
                                    @can('platform_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.platforms.index') }}">
                                            {{ trans('cruds.platform.title') }}
                                        </a>
                                    @endcan
                                    @can('ferry_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.ferries.index') }}">
                                            {{ trans('cruds.ferry.title') }}
                                        </a>
                                    @endcan
                                    @can('type_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.types.index') }}">
        ...
        <main class="py-4">
            ...
            @endif
            {!! \gateweb\common\presenter\Laraview::message_display() !!}
            @if($errors->count() > 0)
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
